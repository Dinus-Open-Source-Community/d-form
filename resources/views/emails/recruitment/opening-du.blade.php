                ...
                <table
                    ...
                    <tr>
                        <td style="padding:0 40px 30px 40px; color:#333;">
                            <h3 style="margin:0; font-weight:bold;">Hello, {{ $nama_lengkap }} !</h3>
                            <p style="margin:10px 0;">Berikut adalah QR untuk pembukaan, silahkan ditunjukkan kepada
                                panitia besok yaa</p>
                            <div class="responsive-box"
                                ...
                                <img src="{{ $qr_url }}" alt="QR Code"
                                    style="max-width:100%; height:auto; margin-bottom:10px;" width="500"
                                    height="500" />
                                <p
