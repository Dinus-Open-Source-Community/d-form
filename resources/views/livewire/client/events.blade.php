<div class="pt-32 min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30">
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                        fill="none" stroke="#466F97" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-100">
                            <div class="flex items-center justify-between flex-wrap gap-2">
                                <div class="text-sm text-gray-600">
                                    @if($search && $categoryFilter)
                                        Menampilkan hasil untuk "<strong>{{ $search }}</strong>" dalam kategori
                                        "<strong>{{ ucfirst($categoryFilter) }}</strong>"
                                    @elseif($search)
                                ...
                                <button wire:click="clearFilters" type="button"
                                    class="text-primary cursor-pointer hover:text-[#5a7ca3] font-medium text-sm bg-primary/10 hover:bg-primary/20 px-3 py-1 rounded-full transition-all duration-200 flex items-center gap-1">
    ...
    <livewire:client.components.event-list :search="$search" :categoryFilter="$categoryFilter" :showToday="true"
