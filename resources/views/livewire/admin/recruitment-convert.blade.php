<div class="flex min-h-screen flex-col bg-gray-50">
    ...
    <div class="mx-auto mt-4 w-full max-w-7xl rounded-xl bg-white p-4 shadow-lg md:mt-12 md:p-8">
        ...
        <div class="overflow-x-auto rounded-lg border border-gray-200 bg-white">
            <table
                class="w-full min-w-[900px] border-collapse overflow-hidden rounded-lg bg-white text-black shadow-md md:text-sm">
                <thead>
                ...
                <tbody class="divide-y divide-gray-200 text-xs">
                    @forelse($recruitments as $item)
                        <tr class="transition hover:bg-gray-50">
                            ...
                            <td class="truncate px-3 py-2 md:px-4">
                                {{ $item->created_at->format('d-m-Y') }}</td>
                            <td class="px-3 py-2 text-center md:px-4">
                                @if ($item->cv)
                                    <a class="text-gray-600 hover:text-gray-800" href="{{ Storage::url($item->cv) }}"
                                        target="_blank">
