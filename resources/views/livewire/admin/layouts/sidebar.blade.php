<div class="min-h-screen h-full w-80 bg-primary text-white flex flex-col z-40 flex-shrink-0">
    ...
    <div class="flex-grow overflow-y-auto">
        ...
        <a href="{{ route('admin.recruitment-convert') }}" wire:navigate>
            <div
                class="flex items-center rounded-lg p-4 m-2 {{ request()->is('admin/recruitment-convert') ? 'bg-white/10' : '' }} hover:bg-white/10 cursor-pointer transition-colors ease-in-out duration-200">
                <span class="material-icons mr-2">
                    file_download
                </span>
                Export Recruitment
